  ...
  return (
    <>
      ...
      <div className="relative w-full h-full pb-64 sm:pb-48 pt-12 lg:pt-4">
        <picture>
          <source media="(max-width: 600px)" srcSet={asset_partners.img_bg_phone} />
          <source media="(max-width: 1000px)" srcSet={asset_partners.img_bg_tablet} />
        ...
        <div className="w-full z-1 relative">
          <div className="flex flex-col items-center gap-2.5 px-4">
            <img src={asset_partners.img_stars} className="size-[120px] md:size-[152px]" />
