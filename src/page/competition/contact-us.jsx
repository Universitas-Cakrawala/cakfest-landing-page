...
import { Button_About_Competition, Button_Contact_Us_Competition } from "./button-svg";

const Contact_Us = () => {
  return (
    <div className="w-full h-full relative pt-64 pb-80 sm:pb-64">
      <picture>
        <source media="(max-width: 600px)" srcSet={asset_contact_us.img_bg_phone} />
        <source media="(max-width: 1000px)" srcSet={asset_contact_us.img_bg_tablet} />
