      ...
      <div className="flex relative w-full h-full">
        <picture>
          <source
            ...
            srcSet={asset_prize_pool.img_bg_phone}
          />
          <source
            media="(max-width: 1000px)"
            srcSet={asset_prize_pool.img_bg_tablet}
          />
          <source
            media="(min-width: 1001px)"
            srcSet={asset_prize_pool.img_bg}
          />
          <img
        ...
        <div className="flex flex-col items-center w-full h-full gap-2.5 pt-16 px-4 relative pb-72 sm:pb-84">
          ...
          <picture>
            <source
              media="(max-width: 600px)"
              srcSet={asset_prize_pool.img_prize_phone}
            />
            <source
              media="(max-width: 1000px)"
              srcSet={asset_prize_pool.img_prize_tablet}
            />
            <source
              media="(min-width: 1001px)"
              srcSet={asset_prize_pool.img_prize}
            />
            <img
