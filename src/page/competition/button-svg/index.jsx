...
export const Button_Guidebook_detail_competition = () => {
  return (
    <a className="cursor-pointer hover:scale-105 group" aria-label="Guide Book">
      <svg
        width="294"
        height="61"
        viewBox="0 0 294 61"
      ...
      >
        ...
        <path
          d="M71.0467 40.4329V37.7979H68.3187V22.9799H71.0467V20.3139H80.4707V22.9799H83.2297V29.8309H79.2617V24.5609H72.2557V36.2169H79.2617V35.1319H76.5337V32.4659H73.7747V28.2809H77.7427V30.8849H83.2297V37.7979H80.4707V40.4329H71.0467ZM89.7254 40.4329V37.7979H86.9974V25.6149H90.9344V36.2169H97.9404V25.6149H101.908V37.7979H99.1494V40.4329H89.7254ZM105.676 40.4329V25.6149H109.613V40.4329H105.676ZM105.676 24.5609V20.3139H109.613V24.5609H105.676ZM116.124 40.4329V37.7979H113.396V28.2809H116.124V25.6149H124.37V20.3139H128.338V37.7979H125.548V40.4329H116.124ZM117.333 36.2169H124.339V29.8309H117.333V36.2169ZM134.197 40.4329V37.7979H131.469V28.2809H134.197V25.6149H143.621V28.2809H146.38V32.4659H142.412V29.8309H135.406V30.8849H140.893V35.1319H135.406V36.2169H142.412V33.5199H146.38V37.7669H143.621V40.4329H134.197ZM159.082 40.4329V37.7979H156.354V22.9799H159.082V20.3139H168.506V22.9799H171.265V29.8309H168.506V30.8849H171.265V37.7979H168.506V40.4329H159.082ZM160.291 36.2169H167.297V32.4659H161.81V28.2809H167.297V24.5609H160.291V36.2169ZM177.155 40.4329V37.7979H174.427V28.2809H177.155V25.6149H186.579V28.2809H189.338V37.7979H186.579V40.4329H177.155ZM178.364 36.2169H185.37V29.8309H178.364V36.2169ZM195.834 40.4329V37.7979H193.106V28.2809H195.834V25.6149H205.258V28.2809H208.017V37.7979H205.258V40.4329H195.834ZM197.043 36.2169H204.049V29.8309H197.043V36.2169ZM211.785 40.4329V20.3139H215.722V30.8849H217.241V28.2809H222.728V25.6149H226.696V29.8309H223.937V32.4659H218.45V33.5509H223.937V36.2169H226.696V40.4329H222.728V37.7979H217.241V35.1319H215.722V40.4329H211.785Z"
...
export const Button_About_Competition = () => {
  return (
    <Link to="/about" className="cursor-pointer hover:scale-105 group" aria-label="About Us">
      <svg width="294" height="61" viewBox="0 0 294 61" xmlns="http://www.w3.org/2000/svg">
        <rect
          x="6"
          y="0.958008"
          width="282"
    ...
    >
      ...
      >
        ...
        <rect
          ...
          className="fill-[#E6B62E] group-hover:brightness-90"
        />
        <rect x="6" y="56.958" width="282" height="4" className="fill-[#B48E24]" />
        <rect x="285" y="53.958" width="6" height="3" className="fill-[#B48E24]" />
        <rect x="6" y="0.958008" width="282" height="4" className="fill-[#FDD35C]" />
        <rect x="3" y="4.95801" width="6" height="3" className="fill-[#FDD35C]" />
        <path
    ...
    >
      ...
      >
        ...
        <g mask="url(#mask0_95_2)">
          ...
          <rect x="117" y="4" width="109" height="4" transform="rotate(180 117 4)" fill="#A865B5" />
          <rect x="8" y="8" width="4" height="4" transform="rotate(180 8 8)" fill="#A865B5" />
          <rect x="4" y="12" width="4" height="4" transform="rotate(180 4 12)" fill="#A865B5" />
          <path
