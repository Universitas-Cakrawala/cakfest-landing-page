      ...
      <div className="w-full min-h-screen relative">
        <picture>
          <source
            ...
            srcSet={asset_about.img_bg_hero_phone}
          />
          <source
            media="(max-width: 1000px)"
            srcSet={asset_about.img_bg_hero_tablet}
          />
          <source
            media="(min-width: 1001px)"
            srcSet={asset_about.img_bg_hero}
          />
          <img
        ...
        <div className="relative z-1 flex flex-col items-center w-full h-full gap-10 sm:gap-16 pt-52 sm:pt-64 pb-64 px-4">
          <img
